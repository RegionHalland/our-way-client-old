...
const Header = ({ siteTitle }) => (
  <header>
      ...
      <div className="py-1 md:py-2 px-3 wrapper flex md:justify-end">
  		  <a className="mr-3 md:mr-0 md:ml-3 text-sm no-underline text-grey-light" href="https://www.visithalland.com/kakor">Cookies</a>
  		  <a className="mr-3 md:mr-0 md:ml-3 text-sm no-underline text-grey-light" href="https://www.visithalland.com/om-oss">Om oss</a>
        <a className="mr-3 md:mr-0 md:ml-3 text-sm no-underline text-grey-light" href="https://www.visithalland.com/">Visithalland</a>
      </div>
  	</div>
