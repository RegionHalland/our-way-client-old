...
const Header = ({ siteTitle }) => (
  <header>
      ...
      <div className="py-1 md:py-2 px-3 wrapper flex md:justify-end">
  		  <a className="mr-2 md:mr-0 md:ml-3 text-sm no-underline text-grey-light" href="#">Cookies</a>
  		  <a className="mr-2 md:mr-0 md:ml-3 text-sm no-underline text-grey-light" href="#">Om oss</a>
      </div>
  	</div>
