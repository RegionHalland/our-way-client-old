...
const UploadListItem = ({ resource }) => (
	<div className="py-4 flex items-center justify-between border-t border-grey-light">
  		<a target="_blank" rel="noopener noreferrer" className="block font-semibold text-black text-lg" href={resource.file.url.localFile.publicURL}>{resource.file.name}</a>
